---
title: 創意生產力 — 強化創意團隊
description: 適合擁有搖滾明星創意人員，但需要提升生產力的公司。 「Adobe內容供應鏈」提供充滿GenAI的工具，可協助該團隊進行內容製作、交付和探索。
...
適合擁有搖滾明星創意人員但需要展示其內容建立的公司。 Adobe內容供應鏈提供充滿GenAI的工具，可協助該團隊提升內容生產、交付和發現能力。

## 主要業務使用案例

* 透過GenAI支援的創意構想與編輯，節省創意專業人員的時間
* 促進創意人員之間的共同作業和審查
* 輕鬆存取現有資產，以通知新內容建立
    ...
    <tr>
      <td style="width:33%">
        <a href="https://experienceleague.adobe.com/docs/courses/using/ExperienceManager-A-1-2020.1.aem" target="_blank">
          <img alt="設定Experience Manager的管理存取權" src="https://cdn.experienceleague.adobe.com/thumb/configure-access-to-aem-for-administrators.jpg">
        </a>
        <div>
          <a href="https://experienceleague.adobe.com/docs/courses/using/ExperienceManager-A-1-2020.1.aem" target="_blank">
...
<div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Creative Cloud and Assets Essentials" tabIndex="8">
  <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
    ...
    <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
      <div class="top-card-content">
          ...
          <p class="is-size-6"><em>瞭解如何將Assets Essentials與Adobe Creative Cloud Libraries整合。</em></p>
      </div>
  ...
  <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
    <div class="card-image">
      <figure class="image x-is-16by9">
        <a href="https://experienceleague.adobe.com/docs/experience-manager-learn/assets/creative-workflows/aem-desktop-app.html" title="使用 AEM 桌面應用程式" tabindex="-1">
          <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/28868?format=jpeg" alt="使用 AEM 桌面應用程式">
        </a>
      </figure>
    </div>
    <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
      <div class="top-card-content">
          <p class="headline is-size-6 has-text-weight-bold">
              <a href="https://experienceleague.adobe.com/docs/experience-manager-learn/assets/creative-workflows/aem-desktop-app.html" title="使用 AEM 桌面應用程式">使用AEM案頭應用程式</a>
          </p>
          <p class="is-size-6"><em>使用AEM案頭應用程式，針對任何應用程式和檔案格式，簡化存取AEM在案頭上管理之任何資產的作業。</em></p>
      </div>
    ...
    <div class="card-image">
      <figure class="image x-is-16by9">
        <a href="https://experienceleague.adobe.com/docs/experience-manager-learn/content-fragments-console/overview.html" title="內容片段主控台影片" tabindex="-1">
          <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3419311?format=jpeg" alt="內容片段主控台影片">
        </a>
      </figure>
    </div>
    <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
      <div class="top-card-content">
          ...
          <p class="is-size-6"><em>影片集合，可協助您瞭解並使用AEM內容片段控制檯和編輯器。</em></p>
      </div>
  ...
  <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
    <div class="card-image">
      <figure class="image x-is-16by9">
        <a href="https://experienceleague.adobe.com/docs/experience-manager-learn/sites/page-authoring/page-authoring-overview-feature-video-use.html" title="編寫頁面" tabindex="-1">
          <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/31828?format=jpeg" alt="編寫頁面">
        </a>
      </figure>
    </div>
    <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
      <div class="top-card-content">
          <p class="headline is-size-6 has-text-weight-bold">
              <a href="https://experienceleague.adobe.com/docs/experience-manager-learn/sites/page-authoring/page-authoring-overview-feature-video-use.html" title="編寫頁面">編寫頁面</a>
          </p>
          <p class="is-size-6"><em>瞭解如何使用網站編輯器的UI在Adobe Experience Manager Sites中編寫頁面。</em></p>
      </div>
